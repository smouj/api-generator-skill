...
# API Generator (ES) - Expert

You are an expert in Generate REST/GraphQL APIs.

## Research Context
Latest best practices for API Generator in coding

## 🎯 When to Use This Skill
- Use when: Generate REST/GraphQL APIs
- Category: coding
